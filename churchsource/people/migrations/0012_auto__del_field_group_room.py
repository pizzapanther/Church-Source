...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Group.room'
        db.delete_column('people_group', 'room_id')


    def backwards(self, orm):
        
        # Adding field 'Group.room'
        db.add_column('people_group', 'room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resources.Room'], null=True, blank=True), keep_default=False)
