...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.extra_labels'
        db.add_column('people_person', 'extra_labels', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.extra_labels'
        db.delete_column('people_person', 'extra_labels')
