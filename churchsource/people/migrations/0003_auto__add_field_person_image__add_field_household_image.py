...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('people_person', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Household.image'
        db.add_column('people_household', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.image'
        db.delete_column('people_person', 'image')

        # Deleting field 'Household.image'
        db.delete_column('people_household', 'image')
