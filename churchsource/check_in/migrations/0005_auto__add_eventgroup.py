...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('check_in_eventgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['check_in.Event'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Group'])),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resources.Room'])),
        ))
        db.send_create_signal('check_in', ['EventGroup'])

        # Removing M2M table for field groups on 'Event'
        db.delete_table('check_in_event_groups')


    def backwards(self, orm):
        
        # Deleting model 'EventGroup'
        db.delete_table('check_in_eventgroup')

        # Adding M2M table for field groups on 'Event'
        db.create_table('check_in_event_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['check_in.event'], null=False)),
            ('group', models.ForeignKey(orm['people.group'], null=False))
        ))
        db.create_unique('check_in_event_groups', ['event_id', 'group_id'])
    ...
    models = {
        ...
        'check_in.eventgroup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['resources.Room']"})
        },
        'people.group': {
