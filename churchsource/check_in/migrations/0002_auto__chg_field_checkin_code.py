...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CheckIn.code'
        db.alter_column('check_in_checkin', 'code', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))


    def backwards(self, orm):
        
        # Changing field 'CheckIn.code'
        db.alter_column('check_in_checkin', 'code', self.gf('django.db.models.fields.CharField')(default='1234', max_length=4))
