...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Event'
        db.create_table('check_in_event', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('end', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('check_in', ['Event'])

        # Adding model 'CheckIn'
        db.create_table('check_in_checkin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'])),
            ('cin', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('cout', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ))
        db.send_create_signal('check_in', ['CheckIn'])

        # Adding M2M table for field events on 'CheckIn'
        db.create_table('check_in_checkin_events', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('checkin', models.ForeignKey(orm['check_in.checkin'], null=False)),
            ('event', models.ForeignKey(orm['check_in.event'], null=False))
        ))
        db.create_unique('check_in_checkin_events', ['checkin_id', 'event_id'])


    def backwards(self, orm):
        
        # Deleting model 'Event'
        db.delete_table('check_in_event')

        # Deleting model 'CheckIn'
        db.delete_table('check_in_checkin')

        # Removing M2M table for field events on 'CheckIn'
        db.delete_table('check_in_checkin_events')
