...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventGroup.room'
        db.alter_column('check_in_eventgroup', 'room_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resources.Room'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'EventGroup.room'
        raise RuntimeError("Cannot reverse this migration. 'EventGroup.room' and its values cannot be restored.")
