...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('check_in_event', 'link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['check_in.Event'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.link'
        db.delete_column('check_in_event', 'link_id')
