...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CheckIn.extra'
        db.add_column('check_in_checkin', 'extra', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CheckIn.extra'
        db.delete_column('check_in_checkin', 'extra')
    ...
    models = {
        'check_in.checkin': {
            ...
            'extra': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
