...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CheckIn.pager'
        db.add_column('check_in_checkin', 'pager', self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CheckIn.pager'
        db.delete_column('check_in_checkin', 'pager')
